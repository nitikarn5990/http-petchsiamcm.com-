...
<div class="row">
    <div class="col-md-12">
        <form class="form-horizontal well " id="myForm2" enctype="multipart/form-data"  method="POST" 
            ...
            <div class="row">
                ...
                <div class="col-md-6"  style="padding-bottom:10px;">
                    ...
                    <input type="text" class="form-control" id="" name="bank_company" data-validation="required" >

                </div>
                <div class="col-md-6"  style="padding-bottom:10px;">
                    เลขที่บัญชี<em>*</em><br />
                ...
                <div class="col-md-6"  style="padding-bottom:10px;">
                    ประเภทบัญชี<em>*</em><br />

                    <input type="text" class="form-control" id="" name="bank_type_account" data-validation="required" >

                </div>
                <div class="col-md-6"  style="padding-bottom:10px;">
                    แนบสำเนาหน้าสมุดบัญชี<em></em><br />
...
// pre-submit callback 
    function showRequest(formData, jqForm, options) {
        ...
        //  console.log($('#firstname').fieldValue());
