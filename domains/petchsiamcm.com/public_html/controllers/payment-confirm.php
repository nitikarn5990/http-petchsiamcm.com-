    ...
    if ($response["success"] === true) {
        ...
        if ($payment_confirm->Save()) {
            ...
            //  SetAlert('เพิ่ม แก้ไข ข้อมูลสำเร็จ', 'success');
              echo "<script>  $(document).ready(function(){   noty({  text: 'สำเร็จ', type: 'success',
                    theme: 'relax',
                    timeout: 5000, }); });</script>";
...
<div class="col-md-12 well">
    ...
    <div class="col-md-12">
        <form class="form-horizontal" enctype="multipart/form-data"  method="POST" action="<?php echo ADDRESS ?>payment-confirm">
            <h4>
                ข้อมูลการโอนเงิน
            </h4>
            <div class="row">
                <div class="col-md-12"  style="padding-bottom:10px;">
                    ...
                    <span>
                        <input type="text" class="form-control" id="order_id" name="order_id"  data-validation="required,number" value="<?= $order_id ?>">
                    </span> 
                </div>
            </div>
            <div class="row">
