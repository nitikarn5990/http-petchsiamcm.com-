    ...
    <form class="form-horizontal form-paymentss well " enctype="multipart/form-data"  method="POST" action="<?php echo ADDRESS ?>payment-confirm">
        ...
        <div class="row">
            ...
            <div class="col-md-6"  style="padding-bottom:10px;">
                เบอร์โทร<em>*</em><br />
                <span>
                    <input type="text" class="form-control" name="tel"  data-validation="number,required">
                </span> 
            </div>
        </div>
        <div class="row">
            <div class="col-md-6"  style="padding-bottom:10px;">
                Email<em>*</em><br />
                <span>
                    <input type="text" name="email" class="form-control" id="email"  data-validation="required,email">
                </span> 
            </div>

            <div class="col-md-6"  style="padding-bottom:10px;">
                จำนวนเงินที่ชำระ<em>*</em><br />
                <span> 
                    <input type="text" class="form-control" id="transfer_amount" name="transfer_amount"  data-validation="required,number">
                </span> 
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-6"  style="padding-bottom:10px;">
                ...
                <div class="col-md-6" style="padding-left: 0;">
                    <select class="form-control col-md-6" id="transfer_min" name="transfer_min"  data-validation="required,number">
